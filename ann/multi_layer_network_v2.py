...
class MLNetwork:
    ...
    def __init__(self, layer_config, minibatch_size=100):
        ...
        for i in range(self.num_layers-1):
            if i == 0:
                ...
                # weight.
                self.layers.append(MLNetwork.Layer([layer_config[i]+1, layer_config[i+1]],
                                         minibatch_size,
                                         is_input=True))
            else:
        ...
        self.layers.append(MLNetwork.Layer([layer_config[-1], None],
                                 minibatch_size,
                                 is_output=True,
    ...
    def train(self, train_data, train_labels, test_data, test_labels,
                 num_epochs=500, eta=0.05, eval_train=True, eval_test=True):
        ...
        for t in range(0, num_epochs):
            ...
            for b_data, b_labels in zip(train_data, train_labels):
                b_labels=np.atleast_2d(b_labels).T
